...
<div class="container">
    ...
    <div class="main">
        <div class="main-wrapper">
            <aside class="nav">
                <ul>
                    <li class="chosen"><a href="/admin/user" class="fa fa-users">用户</a></li>
            ...
            <div class="content">
                ...
                <form name="addUser" method="post" action="/admin/user/add">
                    {!! csrf_field() !!}
                    <ul class="pf-items">
                        <li>
                ...
                <div class="action">
                    <a href="javascript:void(0)" onclick="document.addUser.submit();">完成</a>
                    <a href="/admin/user" class="cancel">取消</a>
                </div>
            </div>
        </div>
    </div>
