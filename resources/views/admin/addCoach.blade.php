        ...
        <div class="main-wrapper">
            <aside class="nav">
                <ul>
                    ...
                    <li class="chosen"><a href="/admin/coach" class="fa fa-clipboard">教练</a></li>
            ...
            <div class="content">
                ...
                <form name="addCoach" method="post" action="/admin/coach/add">
                    {!! csrf_field() !!}
                    <ul class="pf-items">
                        <li>
                ...
                <div class="action">
                    <a href="javascript:void(0)" onclick="document.addCoach.submit();">完成</a>
                    <a href="/admin/coach" class="cancel">取消</a>
                </div>
            </div>
        </div>
    </div>
