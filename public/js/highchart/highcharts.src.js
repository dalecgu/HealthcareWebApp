...
defaultOptions = {
	...
	global: {
		useUTC: true,
		//timezoneOffset: 0,
		canvasToolsURL: 'http://code.highcharts.com/4.1.8/modules/canvas-tools.highchart',
...
if (useCanVG) {
	...
	/**
	 * Start with an empty symbols object. This is needed when exporting is used (exporting.src.highchart will add a few symbols), but
